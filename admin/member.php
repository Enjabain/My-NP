...
<h2>' . $member_username . '&apos;s Info</h2>
	<table>
<tr><th>Name</th><th>Email</th><th>Volunteer Interests</th><th>Type</th><th>Edit</th>
';
    echo '<tr><td>' . $member_firstname . ' ' . $member_lastname . '</td>';
    echo '<td><a href="mailto:' . $member_email . '">' . $member_email . '</td>';
    ...
    foreach ($query3 as $row3) {
        $name = $row3['name'];
        $volunteer_type_id = $row3['volunteer_type_id'];
        $volunteermember_id = $row3['member_id'];
...
<?php
echo'
<h2>' . $member_username . '&apos;s Jobs</h2>
	<table>
<tr><th>Name</th><th>Description</th><th>Type</th><th>Best Finished By Date</th><th>Time Spent</th><th>Status</th>
';
